      ...
      <div class="product bg-light">
        <div class="product__badge">
          <div class="product__actions">
            <div class="product__discount" style="${elem.sale ? '' : 'visibility: hidden'}">-${elem.sale || ''}</div>
            <div class="product__icons">
              <a class="border-0">
                <div class="product__icon-container"><i class="product__icon fa-regular fa-heart"></i></div>
              </a>
              <a href="product-details.html?id=${elem.id}"  class="border-0">
                <div class="product__icon-container"><i class="product__icon fa-regular fa-eye"></i></div>
              </a>
            </div>
          </div>
        ...
        <div>
          ...
          <div class="product__rating">
            ${[...Array(5)].map((_, i) =>
              `<i class="product__rating-star ${i < elem.Rating ? "fa-solid" : "fa-regular"} fa-star"></i>`
            ).join('')}
            <p class="product__rating-count">(${elem.ratingPeople})</p>
          </div>
          <div class="col-md-12">
            <button class="btn btn-dark w-100 cartBTn" data-id="${elem.id}">Add To Cart</button>
          </div>
        </div>
      </div>
    `;
