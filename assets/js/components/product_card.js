    ...
    connectedCallback() {
        ...
        this.innerHTML = `
            ...
            <div class="product mt-3 w-100">
                <div class="product__badge position-relative overflow-hidden rounded mb-3">
                    <div class="product__actions d-flex position-absolute justify-content-between w-100 p-3">
                        ...
                        <div class="product__icons d-flex flex-column position-absolute gap-1">
                            ...
                            <a href="/customer/product-details/product-details.html?id=${this.getAttribute('id')}">
                    ...
                    <img src="${this.getAttribute('image')}" id="productImage" class="product__image position-absolute top-50 start-50" src="" alt="">
                ...
                <h6 id="productName" class="product__title mb-2">${this.getAttribute('name')}</h6>
                <div class="product__price d-flex gap-2 mt-2">
                    <h6 id="productPrice" class="product__price-new primary-color">$${this.getAttribute('price')}</h6>
                ...
                <div class="product__rating mb-3">
                    ...
                    ${[...Array(5)]
                .map((_, i) =>
                    `<i class="product__rating-star ${i < this.getAttribute('rating') ? "fa-solid" : "fa-regular"} fa-star"></i>`
                ).join("")}
                    </div>
                    <p id="productRatingCount" class="product__rating-count fw-semibold opacity-50">${this.getAttribute('ratingCount')}</p>
                </div>
            </div>
            `;
